// Certificates.js - Refactored with formData
...
export default function Certificates() {
  ...
  // Update certificate preview when any parameter changes
  useEffect(() => {
    if (!isEditing && editorRef.current) {
      editorRef.current.innerHTML = getCertificatePreview();
      setEditableHTML(getCertificatePreview());
    }
  }, [
    ...
    formData.disabilityRate,
    formData.deathReason,
    formData.contagiousDisease,
  ...
  const handlePrint = () => {
    const content = isEditing ? editableHTML : getCertificatePreview();
        ...
        <div className="w-full lg:w-1/2">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    ...
                    if (newEditingState && editorRef.current && !editableHTML) {
                      editorRef.current.innerHTML = getCertificatePreview();
                      setEditableHTML(getCertificatePreview());
                    }
                  }}
                ...
                >
                  {isEditing ? "En cours d'édition" : "Mode édition"}
                </button>
                <button
                  onClick={handlePrint}
            ...
            {isEditing && (
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  ...
                  Vous pouvez modifier le texte directement dans l'aperçu.
                  Cliquez sur "Réinitialiser" pour revenir au modèle original.
                </p>
            ...
            <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 min-h-[600px] overflow-auto">
              <div
                ref={editorRef}
                className={`bg-white p-8 min-h-[550px] ${
                ...
                style={{
                  outline: isEditing ? "2px solid #54c2bc" : "none",
                  outlineOffset: "2px",
                }}
              />
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="flex gap-3">
                <button
                  onClick={handlePrint}
                  className="flex-1 py-3 bg-[#54c2bc] text-white rounded-lg hover:bg-[#3BAAA4] transition-colors font-medium text-sm flex items-center justify-center"
                >
                  <svg
                    className="w-4 h-4 mr-2"
                    fill="none"
