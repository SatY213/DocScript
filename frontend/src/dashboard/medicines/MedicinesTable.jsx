...
const MedicinesTable = () => {
  ...
  const handleAddMedicine = () => {
    navigate("/dashboard/medicines/create");
  };
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Gérez et suivez tous vos médicaments
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1 relative">
                <input
                  type="text"
                  placeholder="Rechercher un medicine..."
                  value={searchQuery}
          ...
          {medicines.length > 0 ? (
                ...
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                      <div className="flex items-center">Classe</div>
                    </th>
                    ...
                    >
                      <div
                        ...
                        onClick={() =>
                          handleSort("dosage", setSortName, setSortDosage)
                        }
                      >
                        Dosage <SortIcon />
                      </div>
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            onClick={() => {
                              window.scrollTo(0, 0);
                              navigate(
                                `/dashboard/medicines/view/${medicine._id}`
                              );
                            }}
                          >
                            Voir
                          ...
                          <button
                            ...
                            onClick={() => {
                              window.scrollTo(0, 0);
                              navigate(
                                `/dashboard/medicines/update/${medicine._id}`
                              );
                            }}
                          >
                            Éditer
                          ...
                          <button
                            onClick={() => handleDeletePopup(medicine._id)}
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">
                {searchQuery
                  ? "Aucun medicine ne correspond à vos critères de recherche. Essayez de modifier vos filtres."
                  : "Vous n'avez pas encore de medicines dans votre base de données."}
              </p>
              <button
                onClick={handleAddMedicine}
              ...
              >
                ...
                Ajouter votre premier médicament
              </button>
            </div>
          )}
        </div>
